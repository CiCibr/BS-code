...
LOG_FILE = 'D:/pythonProject1/CSDN_Short-Video-Streaming-Challenge-main/logs/log.txt'
...
class Environment:
    def __init__(self, user_sample_id, all_cooked_time, all_cooked_bw, video_num, seeds):
        ...
        self.seeds = seeds
        global USER_FILE
        USER_FILE = 'D:/pythonProject1/CSDN Short-Video-Streaming-Challenge-main/logs/sample_user/user_'+str(user_sample_id)+'.txt'
    ...
    def play_videos(self, action_time):  # play for action_time from the start of current players queue
        ...
        while buffer >= 0 and action_time > 0:
            ...
            if actual_play_time == video_remain_time:
                ...
                print("User watched for ", self.user_models[0].get_ret_duration(), " ms, you downloaded ", self.players[0].get_chunk_counter()*VIDEO_CHUNCK_LEN, " sec.", file=log_file)
                ...
                print("Your downloaded bitrates are: ", video_qualities, ", therefore your smooth penalty is: ", smooth, file=log_file)
            ...
            if self.play_video_id >= self.video_num:
                ...
                print("played out!", file=log_file)
                break
